...
# Create src/app.js - Main application logic
app_js = '''// ============================================================================
...
with open('greenfuel-frontend/src/app.js', 'w') as f:
    f.write(app_js)

print("✓ Created src/app.js (Pure Vanilla JavaScript)")
print(f"   File size: {len(app_js) / 1024:.1f} KB")
print("\n   Features:")
print("   - Pure Vanilla JS (no frameworks)")
print("   - Dynamic form generation")
print("   - Mock and API predictions")
print("   - Event handling")
print("   - Model data integration")
